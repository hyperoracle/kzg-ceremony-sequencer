...
use hex_literal::hex;
#[cfg(feature = "halo2")]
use kzg_ceremony_circuit::halo2_proofs::pairing::bls12_381::{G1Affine, G2Affine};
...
impl G1 {
    ...
    pub fn to_point(&self) -> G1Affine {
        G1Affine::from_compressed_unchecked(&self.0).unwrap()
    }
}
...
impl G2 {
    ...
    pub fn to_point(&self) -> G2Affine {
        G2Affine::from_compressed_unchecked(&self.0).unwrap()
    }
}
